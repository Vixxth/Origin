...
/*:
 * @plugindesc v.1.1.0 Allows you to expand the coverage of the event by several tiles
 * @author DKPlugins
...
/*:ru
 * @plugindesc v.1.1.0 Позволяет расширить зону действия события на несколько тайлов
 * @author DKPlugins
 * @url https://dk-plugins.ru
 * @target MZ
 * @help
...
Game_Event.prototype.setupEventSize = function() {
    ...
    const comment = comments.find(comment => comment.match(regex));
