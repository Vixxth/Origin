...
@plugindesc v4.1.8 - Essential plugin for all Eli plugins.
...
Update log
============================================================================
Version 4.1.8 - 01/14/2022
- Fixed a Sprite property name conflict with the default core codes.
Version 4.1.7 - 12/19/2021
- Compatibility with the Pixel Movement plugin DotMoveSystem and 
DotMoveSystem_FunctionEx from unagi ootoro:
...
Version 4.1.6 - 12/09/2021
- Minor compatibility with MZ 1.4.0
Version 4.1.5 - 11/12/2021
- Added different methods to convert colors for changing tone and 
blend colors.
- Add a method on game interpreter to get a follower character or a 
vehicle character.
Version 4.1.4 - 11/09/2021
- Fixed a bug where the Eli Color Manager was converting HTML Colors to 
rgba with alpha value to 0.
Version 4.1.3 - 10/18/2021
- Hopefully fixed a problem with the in built animations on sprites.
- Fixed a problem with MOG_BattleHud (MZ)
...
Sprite.prototype.isAnimationPlaying = function() {
    return this._animationSpritesMV.length > 0 || this._animationSpritesMz.length > 0
}
...
Sprite.prototype.startAnimationMV = function(animation, mirror, delay){
    ...
    this.parent.addChild(sprite)
    this._animationSpritesMV.push(sprite)
}

Sprite.prototype.updateAnimationSprites = function() {
    if (this.isAnimationPlaying()) {
        const sprites = this._animationSpritesMV.clone()
        this._animationSpritesMV = []
...
Game_Interpreter.prototype.getVehicleCharacter = function(vehicleType){
    return $gameMap.vehicles().find(vehicle => Eli.String.removeSpaces(vehicle._type).toLowerCase() === Eli.String.removeSpaces(vehicleType).toLowerCase())
}
